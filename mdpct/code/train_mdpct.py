...
parser.add_argument('--exp', type=str,  default='MDPCT', help='exp_name')
parser.add_argument('--model', type=str,  default='mdpct', help='model_name')
parser.add_argument('--max_iteration', type=int,  default=12000, help='maximum iteration to train')    #15000
