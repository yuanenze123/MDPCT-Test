...
parser.add_argument('--exp', type=str,  default='MPCNet', help='exp_name')
parser.add_argument('--model', type=str,  default='mpcnet', help='model_name')
parser.add_argument('--max_iteration', type=int,  default=16000, help='maximum iteration to train')    #15000
